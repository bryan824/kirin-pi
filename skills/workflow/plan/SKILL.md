...
Deliver: approved plan path, ready work-unit frontier, test seams, and next route (`implement` for one unit, `parallel-work` only for ready file-disjoint units). Stop.
