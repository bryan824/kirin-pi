...
| `bun test test/setup.test.cjs` | Zero-argument global setup works with and without Pi, updates stable shared skills, preserves collisions, never requires project scope, and leaves `~/.pi/agent/settings.json` to `pi install`. |
